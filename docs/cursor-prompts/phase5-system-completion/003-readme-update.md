...
The main README.md is outdated. It doesn't mention:
- Keycloak authentication requirement
- Customer portal functionality
- SNMP integration support
- The distinction between customer and operator access

**Read first**:
- `README.md` (current state)
- `docs/CUSTOMER_PLANE_ARCHITECTURE.md` (architecture decisions)
...
### 3.1 Replace README.md with updated content
...
- [ ] README documents Keycloak authentication
- [ ] README lists customer and operator roles
- [ ] README mentions SNMP support
- [ ] README includes all services (dispatcher, delivery_worker)
- [ ] README has accurate Quick Start with Keycloak URL
- [ ] README lists key API endpoints

**Test**:
```bash
# Visual review - ensure README renders correctly
cat README.md
```
...
```
Update README with complete system documentation

- Add Keycloak authentication section
- Document user roles (customer/operator)
- Add SNMP integration documentation
- Include all services in overview
